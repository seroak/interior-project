...
export const StyleOption = ({ title, description, isSelected, onClick }: StyleOptionProps) => {
  const borderColor = !isSelected ? "border-unselected-gray" : "border-selected-black";
  return (
    <div
      onClick={onClick}
      className={`flex flex-col gap-[10px] px-[32px] py-[40px] rounded-[10px] border-2 ${borderColor} h-full`}
    >
